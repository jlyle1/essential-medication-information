...
Description: "Code system identifying the source of a medication entry (local VA, remote VA, non-VA, pending, etc.)."
...
* #non-va "Non-VA" "Medication from outside the VA system, including OTC, herbal, community pharmacy."
